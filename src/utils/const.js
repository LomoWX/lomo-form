...
export const selectArr = ["el-cascader", "el-time-select", "el-date-picker", "lomo-select", "lomo-tree-select", "lomo-map-input"]

// 组件默认值支持情况，未涉及到的建议在全局手动配置
export const componentDefaultValue = [
  { value: "", keys: ["el-input", "el-autocomplete", "lomo-select", "lomo-tree-select", "el-date-picker", "el-time-select", "lomo-radio"], },
  { value: false, keys: ["el-switch", "lomo-checkbox"] },
  { value: 0, keys: ["el-slider", "el-rate"] },
  { value: () => [], keys: ["el-cascader", "el-transfer", "lomo-upload", "lomo-dynamic-tags", "lomo-map-input"] },
]

// 内置的核心单组件 可省略 ag 前缀的组件
export const lmComponentNames = [
  "lomo-radio",
  "lomo-checkbox",
  "lomo-select",
  "lomo-tree-select",
...
export const lmItemPropKeys = Object.keys(lmItemProps)
