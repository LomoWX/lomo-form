<template>
  ...
  <el-radio-group v-else-if="proxyOptions.length>0" ref="ref" class="lomo-radio-group" :value="value" v-bind="getGroupProps($attrs)"
    v-on="$listeners">
  ...
  <component v-else class="lomo-radio" ref="ref" :is="is" :value="value" v-bind="getProps($attrs)" v-on="$listeners">
