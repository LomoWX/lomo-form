<template>
  ...
  <el-checkbox-group v-else-if="multiple" ref="ref" class="lomo-checkbox-group" :value="proxyValue" v-bind="getGroupProps($attrs)" v-on="$listeners">
  ...
  <component v-else class="lomo-checkbox" :is="is" :value="proxyValue" ref="ref" v-bind="getProps($attrs)" v-on="$listeners">
