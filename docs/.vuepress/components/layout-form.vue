<template>
  <div class="demo border">
    ...
    <el-form :model="data" class="border" label-width="auto" ref="form">
      <!-- 内联布局 -->
      <el-divider content-position="left">lomo-form-inline 内联布局</el-divider>
      <lomo-form-inline :items="inlineItems"></lomo-form-inline>

      <!-- 栅格布局 -->
      <el-divider content-position="left">lomo-form-grid 栅格布局</el-divider>
      <lomo-form-grid :items="gridItems" :span="12"></lomo-form-grid>

      <!-- 描述布局 -->
      <el-divider content-position="left">lomo-form-descriptions 描述布局</el-divider>
      <lomo-form-descriptions :items="decItems" :column="2"></lomo-form-descriptions>

      <!-- 表格编辑器布局, 需要使用 model-prop 属性关联表单数据-->
      <el-divider content-position="left">lomo-form-tableditor 表格编辑器布局</el-divider>
      <lomo-form-tableditor :items="tableItems" model-prop="list"> </lomo-form-tableditor>
